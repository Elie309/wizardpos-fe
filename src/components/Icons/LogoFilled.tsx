export default function LogoFilled({ className }: { className?: string }) {

    return (
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
            width="200.000000pt" height="200.000000pt" viewBox="0 0 250.000000 200.000000"
            preserveAspectRatio="xMidYMid meet" className={className}>

            <g transform="translate(-40.000000,250.000000) scale(0.050000,-0.050000)"
                stroke="none">
